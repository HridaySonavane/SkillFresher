...
import { FileText, Settings, Palette, Download, Share2, Save, Eye, CheckCircle } from "lucide-react"
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          <div className="text-xs text-gray-500">
            Step {currentStep === "template" ? "1" : currentStep === "form" ? "2" : "3"} of 3
          </div>
        </div>
      </div>
          ...
          <CardContent className="p-3 space-y-2">
            {currentStep === "template" && (
              <div className="text-xs text-gray-600 space-y-1">
                ...
                <div className="flex items-start gap-2">
                  <CheckCircle className="w-3 h-3 mt-0.5 text-green-500 flex-shrink-0" />
                  <span>Consider ATS-friendly designs for better compatibility</span>
                </div>
              </div>
            )}
            ...
            {currentStep === "preview" && (
              <div className="text-xs text-gray-600 space-y-1">
                <div className="flex items-start gap-2">
                  <CheckCircle className="w-3 h-3 mt-0.5 text-green-500 flex-shrink-0" />
                  <span>Review for spelling and grammar errors</span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="w-3 h-3 mt-0.5 text-green-500 flex-shrink-0" />
                  <span>Ensure all contact information is correct</span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="w-3 h-3 mt-0.5 text-green-500 flex-shrink-0" />
                  <span>Download in PDF format for best compatibility</span>
                </div>
              </div>
            )}
          </CardContent>
