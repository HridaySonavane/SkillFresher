    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            <span>Resumes:</span>
            <span>{subscription.plan_id === "enterprise" ? "Unlimited" : "Up to 50"}</span>
          </div>
          <div className="flex justify-between">
            <span>Downloads:</span>
            <span>{subscription.plan_id === "enterprise" ? "Unlimited" : "Up to 200"}</span>
          </div>
          <div className="flex justify-between">
            <span>AI Optimizations:</span>
            <span>{subscription.plan_id === "enterprise" ? "Unlimited" : "Up to 100"}</span>
          </div>
        </div>
