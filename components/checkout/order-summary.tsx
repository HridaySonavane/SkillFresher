...
export function OrderSummary({ plan }: OrderSummaryProps) {
  ...
  const savings = isYearly ? (plan.price * 1.2 - plan.price).toFixed(2) : null
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">
                ...
                {monthlyEquivalent && <span className="ml-1">(${monthlyEquivalent}/month)</span>}
              </p>
            </div>
      ...
      <Card className="bg-gray-50">
        <CardContent className="pt-6 text-center">
          ...
          <p className="text-sm text-gray-600 mb-3">Our support team is here to help you get started.</p>
          <div className="space-y-2 text-sm">
            <div>
              <span className="text-gray-500">Email:</span>{" "}
              <a href="mailto:support@resumebuilder.ai" className="text-blue-600 hover:underline">
                support@resumebuilder.ai
              </a>
            </div>
            <div>
              <span className="text-gray-500">Live Chat:</span> <span className="text-green-600">Available 24/7</span>
            </div>
          </div>
        </CardContent>
      </Card>
